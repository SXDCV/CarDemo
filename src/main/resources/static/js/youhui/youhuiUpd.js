...
function getBtn() {
	$("#btn").click(function() {
		...
		if (ytitle.length==0) {
			...
			var xx="ytitle="+ytitle+"&ybegintime="+ybegintime+"&yendtime="+yendtime+"&ymoney="+ymoney+"&ylessmoney="+ylessmoney+"&yid="+yid;
			$.post("youhui.do?method=youhuiUpd",xx,function(mydata){
				if (mydata==true) {
					//修改成功！
