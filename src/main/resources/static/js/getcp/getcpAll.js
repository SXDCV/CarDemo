								...
								},
								{
									...
									formatter : function(value, row, index) {
										var e = '<a href="#" class="btn btn-info btn-xs" onclick="edit(\'' + value
												+ '\')"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp;入库</a> ';
										return e;
									}
								} ,
								{
									...
									align : 'center',
									formatter : function(value, row, index) {
										var e = '<a href="#" class="btn btn-info btn-xs" onclick="getck(\'' + value
												+ '\')"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp;出库</a> ';
										return e;
									}
								}]
					});
...
//入库详情
function edit(fid) {
	window.location.href="getcp.do?method=tolist&fid="+fid;
}

//出库详情
function getck(fid) {
	window.location.href="getcp.do?method=tocp&fid="+fid;
}
